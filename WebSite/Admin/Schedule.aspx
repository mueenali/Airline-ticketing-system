                    ...
                    <div class="modal-body">
                       <div class="panel panel-default">
                           <div class="panel-body">
                               ...
                               <input type="text" class="form-control" v-model="model.FlightId" />
                               <label>Departure Date and Time</label>
                               <input type="text" class="form-control" v-model="model.DepartureDateTime" />
                               <label>Arrival Date and Time</label>
                               <input type="text" class="form-control" v-model="model.ArrivalDateTime" />
                               <label>Aircraft Id</label>
                               <input type="number" class="form-control" v-model="model.AircraftId" />
                           </div>
                       </div>
                    </div>
        ...
        <hr />
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align:center;">Departure Date and Time</th>
                    <th style="text-align:center;">Arrival Date and Time</th>
                    <th style="text-align:center;">Aircraft Id</th>
    ...
    <script>
        var vue = new Vue({
            ...
            methods: {
                update: function () {
                    var scope = this;
                    axios.put('http://localhost:52014/api/ScheduleApi/Put', this.model);
                ...
                del: function (id) {
                    var scope = this;
                    axios.delete(`http://localhost:52014/api/ScheduleApi/${this.ajaxData[id].Id}`).then(function () {
                        scope.ajaxData.splice(id, 1);
                    });
                },
                post: function () {
                    axios.post('http://localhost:52014/api/ScheduleApi/Post', this.model);
                     this.ajaxData.push(this.model);
                },
                loadAll: function () {
                    var scope = this;
                    axios.get('http://localhost:52014/api/ScheduleApi', { headers: { accept: 'application/json' } }).then(function (data) {
                ...
                find: function (id) {
                    var scope = this;
                    axios.get(`http://localhost:52014/api/ScheduleApi/${id}`, { headers: { accept: 'application/json' } }).then(function (data) {
                        var value = data.data;
                        if (value != null) {
                            scope.model = value;
                        }
